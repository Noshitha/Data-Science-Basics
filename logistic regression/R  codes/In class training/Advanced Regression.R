...
numclaims <- read.table("E:/Classes/Trainer Tools/Final/05 Adv Regression/Data Sets/numclaims.txt", header = T)
...
#=============================================
canins <-  read.table("E:/Classes/Trainer Tools/Final/05 Adv Regression/Data Sets/canautoins.txt", header = T)
...
ornstein <- read.table("E:/Classes/Trainer Tools/Final/05 Adv Regression/Data Sets/ornsteindata.txt", header = T)
